...
def generate_config():
    ...
    parser_unatt.add_argument('-dk', '--deploy_key', type=str, required=False,
                              help='8 digits deploy key')
    parser_unatt.add_argument('-sk', '--secret_key', type=str, required=False,
                              help='32 digits secret key')
    ...
    if is_unattended:
        ...
        mail_username = args.mail_user
        mail_password = args.mail_pass
        localconfig['SECRET_KEY'] = args.secret_key
        localconfig['DEPLOY_KEY'] = args.deploy_key
