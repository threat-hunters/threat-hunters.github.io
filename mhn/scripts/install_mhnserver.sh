...
python generateconfig.py unattended --email $SUPERUSER_EMAIL --password $SUPERUSER_PASSWORD --base_url "http://$MHN_IP" --honeymap_url "http://$MHN_IP:3000" --deploy_key $DEPLOY_KEY --secret_key $SECRET_KEY
